...
- `/books/<path>` - сумісний маршрут, який також йде через ту саму безпечну серверну перевірку шляху

Для `/api/folder`, `/book/<path>` і `/books/<path>` діє обмеження доступу лише в межах каталогу книг.
